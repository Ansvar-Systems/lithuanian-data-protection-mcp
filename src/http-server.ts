...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across VDAI (Valstybinė duomenų apsaugos inspekcija) decisions and sanctions.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'slapukai', 'darbuotojų stebėjimas')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Search VDAI guidance documents on GDPR implementation in Lithuania.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific VDAI guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Lithuanian and English names.",
      ...
      switch (name) {
        ...
        case "lt_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "VDAI (Valstybinė duomenų apsaugos inspekcija) MCP server. Provides access to Lithuanian data protection authority decisions and guidance.",
