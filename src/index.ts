...
/**
 * Lithuanian Data Protection MCP — stdio entry point.
 *
 * Provides MCP tools for querying VDAI decisions, sanctions, and
...
const SERVER_NAME = "lithuanian-data-protection-mcp";

// --- Tool definitions ---------------------------------------------------------

const TOOLS = [
  {
    name: "lt_dp_search_decisions",
    description:
    ...
    inputSchema: {
      ...
      properties: {
        query: {
          type: "string",
          description: "Search query (e.g., 'slapukai', 'darbuotojų stebėjimas', 'duomenų pažeidimas')",
        },
        type: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        reference: {
          type: "string",
          description: "VDAI decision reference (e.g., '2N-110-(3.9.)-2022')",
        },
      },
      required: ["reference"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: {
          type: "string",
          description: "Search query (e.g., 'DPIA', 'slapukai', 'duomenų subjekto teisės')",
        },
        type: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        id: {
          type: "number",
          description: "Guideline database ID (from lt_dp_search_guidelines results)",
        },
      },
      required: ["id"],
    },
    ...
    switch (name) {
      ...
      case "lt_dp_about": {
        return textContent({
          ...
          version: pkgVersion,
          description:
            "VDAI (Valstybinė duomenų apsaugos inspekcija — State Data Protection Inspectorate) MCP server. Provides access to Lithuanian data protection authority decisions, sanctions, and official guidance documents.",
          data_source: "VDAI (https://vdai.lrv.lt/)",
          coverage: {
            decisions: "VDAI decisions, sanctions, warnings, and reprimands",
            guidelines: "VDAI guides, recommendations, and FAQs",
